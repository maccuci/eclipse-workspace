package com.fuzion.hg.structure.items;
...
public class MinifeastItems implements Items {
	...
	public static ItemStack generateGift() {
		...
		clayMeta.setDisplayName("§6Item do seu kit");
		ArrayList<String> lore = new ArrayList<>();
		lore.add("§7Clique para ganhar o item do seu kit.");
