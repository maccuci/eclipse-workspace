package me.ale.commons.bukkit.protocol;
...
public class ProtocolGetter {
    ...
    public static void foundDependencies() {
        ...
        try {
            ...
            BukkitMain.getPlugin().getLogger().info("ProtocolSupport encontrado!");
            protocolSupport = true;
        } catch (ClassNotFoundException e) {
            if (version.equals("v1_7_R4")) {
                try {
                    Class.forName("org.spigotmc.ProtocolInjector");
                    BukkitMain.getPlugin().getLogger().info("ProtocolHack encontrado!");
                    protocolHack = true;
        ...
        try {
            ...
            BukkitMain.getPlugin().getLogger().info("ViaVersion encontrado!");
            viaVersion = true;
        } catch (ClassNotFoundException e) {
        }
