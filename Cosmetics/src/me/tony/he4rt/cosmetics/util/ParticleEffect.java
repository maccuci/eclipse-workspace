...
import me.tony.he4rt.cosmetics.util.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	...
	/**
	 * A particle effect which REDSTONEis displayed by primed tnt, torches, droppers, dispensers, end portals, brewing stands and monster spawners:
	 * <ul>
	 ...
	 * <li>The speed value causTOWN_AURAes the particle to be colored red when set to 0
	 * </ul>
	 */
	...
	public void display(Player player, float offsetX, float offsetY, float offsetZ, int speed, int amount) {
		display(offsetX, offsetY, offsetZ, speed, amount, player.getLocation(), player);
	}
	
	public void display(Player player, Location location, float offsetX, float offsetY, float offsetZ, int speed, int amount) {
		display(offsetX, offsetY, offsetZ, speed, amount, location, player);
	}
