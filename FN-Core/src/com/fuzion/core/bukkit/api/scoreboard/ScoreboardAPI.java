package com.fuzion.core.bukkit.api.scoreboard;
...
public class ScoreboardAPI {
	...
	public void createTeamForPlayers(Collection<? extends Player> players, String teamID, String teamPrefix,
			String teamSuffix) {
	...
	public void createTeamIfNotExistsForPlayers(Collection<? extends Player> players, String teamID, String teamPrefix,
			String teamSuffix) {
		for (Player player : players) {
	...
	public void setTeamPrefixAndSuffixForPlayers(Collection<? extends Player> players, String teamID, String prefix,
			String suffix) {
		for (Player player : players) {
	...
	public Objective createObjectiveToPlayer(Player player, String objectiveID, String displayName,
	...
	public void createObjectiveForPlayers(Collection<? extends Player> players, String objectiveID, String displayName,
			DisplaySlot displaySlot) {
		for (Player player : players) {
	...
	public Objective createObjectiveIfNotExistsToPlayer(Player player, String objectiveID, String displayName,
			DisplaySlot displaySlot) {
		Objective objective = getObjectiveFromPlayer(player, objectiveID);
		if (objective == null) {
			createObjectiveToPlayer(player, objectiveID, displayName, displaySlot);
	...
	public void createObjectiveIfNotExistsToPlayer(Collection<? extends Player> players, String objectiveID,
	...
	public void setObjectiveDisplayNameForPlayers(Collection<? extends Player> players, String objectiveID,
			String name) {
		for (Player player : players) {
	...
	public void setObjectiveDisplaySlotForPlayers(Collection<? extends Player> players, String objectiveID,
			DisplaySlot displaySlot) {
		for (Player player : players) {
	...
	public void setScoreOnObjectiveToPlayer(Player player, DisplaySlot objectiveSlot, String scoreName,
			int scoreValue) {
		setScoreOnObjective(getObjectiveFromPlayer(player, objectiveSlot), scoreName, scoreValue);
		player = null;
	}

	public void setScoreOnObjectiveForPlayers(Collection<? extends Player> players, String objectiveID,
	...
	public void setScoreOnObjectiveForPlayers(Collection<? extends Player> players, DisplaySlot objectiveSlot,
			String scoreName, int scoreValue) {
		for (Player player : players) {
			setScoreOnObjective(getObjectiveFromPlayer(player, objectiveSlot), scoreName, scoreValue);
		}
	...
	public void addScoreOnObjectiveToPlayer(Player player, Objective objective, String scoreID, int score, String name,
	...
	public void addScoreOnObjectiveToPlayer(Player player, String objectiveID, String scoreID, int score, String name,
			String prefix, String suffix) {
	...
	public void addScoreOnObjectiveToPlayer(Player player, DisplaySlot objectiveSlot, String scoreID, int score,
	...
	public void addScoreOnObjectiveForPlayers(Collection<? extends Player> players, String objectiveID, String scoreID,
			int score, String name, String prefix, String suffix) {
		for (Player player : players) {
	...
	public void addScoreOnObjectiveForPlayers(Collection<? extends Player> players, DisplaySlot objectiveSlot,
	...
	public void updateScoreNameOnObjectiveToPlayer(Player player, DisplaySlot objectiveSlot, String scoreID,
			String name) {
		updateScoreNameOnObjectiveToPlayer(player, getObjectiveFromPlayer(player, objectiveSlot), scoreID, name);
	}

	public void updateScoreNameOnObjectiveForPlayers(Collection<? extends Player> players, String objectiveID,
			String scoreID, String name) {
		for (Player player : players) {
	...
	public void updateScoreNameOnObjectiveForPlayers(Collection<? extends Player> players, DisplaySlot objectiveSlot,
			String scoreID, String name) {
		for (Player player : players) {
	...
	public void updateScoreValueOnObjectiveToPlayer(Player player, DisplaySlot objectiveSlot, String scoreID,
			String value) {
		updateScoreValueOnObjectiveToPlayer(player, getObjectiveFromPlayer(player, objectiveSlot), scoreID, value);
	}

	public void updateScoreValueOnObjectiveForPlayers(Collection<? extends Player> players, String objectiveID,
	...
	public void updateScoreValueOnObjectiveForPlayers(Collection<? extends Player> players, DisplaySlot objectiveSlot,
			String scoreID, String value) {
		for (Player player : players) {
	...
	public void updateScoreNameAndValueOnObjectiveToPlayer(Player player, Objective objective, String scoreID,
	...
	public void updateScoreNameAndValueOnObjectiveToPlayer(Player player, String objectiveID, String scoreID,
			String name, String value) {
	...
	public void updateScoreNameAndValueOnObjectiveToPlayer(Player player, DisplaySlot objectiveSlot, String scoreID,
			String name, String value) {
		updateScoreNameAndValueOnObjectiveToPlayer(player, getObjectiveFromPlayer(player, objectiveSlot), scoreID, name,
				value);
	}

	public void updateScoreNameAndValueOnObjectiveForPlayers(Collection<? extends Player> players, String objectiveID,
	...
	public void updateScoreNameAndValueOnObjectiveForPlayers(Collection<? extends Player> players,
	...
	public void updateScoreOnObjectiveForPlayers(Collection<? extends Player> players, String objectiveID,
			String scoreID, String score) {
		for (Player player : players) {
	...
	public void updateScoreOnObjectiveForPlayers(Collection<? extends Player> players, DisplaySlot objectiveSlot,
			String scoreID, String score) {
		for (Player player : players) {
