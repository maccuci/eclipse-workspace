...
public class HedgehogKit extends Kit {
	...
	public HedgehogKit() {
		super("Hedgehog", new ItemStack(Material.ARROW), Group.BETA, "§7Clique com o botão direito do mouse no item para atirar flechas em todas as direções ao seu redor, o que causará grandes quantidades de dano aos jogadores atingidos.");
