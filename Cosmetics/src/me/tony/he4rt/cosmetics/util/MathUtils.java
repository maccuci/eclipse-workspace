...
/*            UltraPlayer customPlayer = UltraCosmeticsData.get().getPlugin().getPlayerManager().getUltraPlayer((Player) ent);
        ...
        ent.setVelocity(v);
        Bukkit.getScheduler().runTaskLaterAsynchronously(Main.getPlugin(), () -> FallDamageManager.addNoFall(ent), 5);
    }
...
/*                UltraPlayer customPlayer = UltraCosmeticsData.get().getPlugin().getPlayerManager().getUltraPlayer((Player) ent);
        ...
        ent.setVelocity(v);
        Bukkit.getScheduler().runTaskLaterAsynchronously(Main.getPlugin(), () -> FallDamageManager.addNoFall(ent), 4);
    }
