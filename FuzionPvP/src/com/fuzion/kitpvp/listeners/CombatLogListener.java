...
import com.fuzion.kitpvp.manager.combatlog.CombatLog;
import com.fuzion.kitpvp.manager.combatlog.CombatLogManager;
...
public class CombatLogListener implements Listener {
	...
	public void onPlayerDamage(EntityDamageByEntityEvent event) {
		...
		this.manager.combatMessage(damager);
		this.manager.combatMessage(damaged);
