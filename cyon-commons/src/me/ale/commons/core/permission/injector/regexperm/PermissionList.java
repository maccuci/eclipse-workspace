package me.ale.commons.core.permission.injector.regexperm;
...
import me.ale.commons.core.permission.injector.FieldReplacer;
...
public class PermissionList extends HashMap<String, Permission> {
	...
	private void removeAllChildren(String perm) {
		for (Iterator<Map.Entry<String, Map.Entry<String, Boolean>>> it = childParentMapping.entries().iterator(); it
				.hasNext();) {
